...
<section class="container py-5" style="background: url('{{asset('assets/courses/'.$course->img)}}');background:size:contain;">
    <div class="row">
        <h2 class="text-center text-light pb-5">Book Your Course Now</h2>
    </div> <form method="POST" action="{{route('subscription_payment')}}" >
        @csrf
    <div class="row">
        <div class="col-md-6 col-lg-6 col-sm-12 col-12 pe-5">

            <div class="col2-set w-100" id="customer_details">
                <!-- Billing Details -->
                <div class="w-100 px-5 py-3 rounded-3" style="background:#FFFFFF;">
                    <div class="">
                        ...
                        <div class="woocommerce-billing-fields__field-wrapper">
                            <p class="form-row form-row-first validate-required" id="billing_first_name_field">
                                ...
                                <input type="text" class="form-control w-100" name="name" id="billing_first_name" placeholder="" value="" autofocus="autofocus" />
                                @error('name')
                            ...
                            <p class="form-row form-row-last validate-required" id="billing_last_name_field">
                                ...
                                <input type="text"  class="form-control w-100" name="last_name" id="billing_last_name" placeholder="" value="" />
                            </p>
                            <p class="form-row form-row-wide" id="billing_company_field">
                                <label for="billing_company" class="">Company name</label>
                                <input type="text" class="form-control w-100" name="company_name" id="billing_company" placeholder="" value="" />
                            </p>
                            <p class="form-row form-row-wide address-field update_totals_on_change validate-required" id="billing_country_field">
                                ...
                                <select name="country" id="billing_country" class="form-select border w-100">
                            ...
                            <p class="form-row form-row-wide address-field validate-required" id="billing_address_1_field">
                                ...
                                <input type="text" class="form-control w-100" name="address" id="billing_address_1" placeholder="Street address" value="" />
                                @error('address')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
                            <p class="form-row form-row-wide address-field" id="billing_address_2_field" data-priority="60">
                                <input type="text" class="form-control w-100" name="address_2" id="billing_address_2" placeholder="Apartment, suite, unit etc. (optional)" value="" />
                            </p>
                            <p class="form-row form-row-wide address-field validate-required" id="billing_city_field">
                                ...
                                <input type="text" class="form-control w-100 " name="city" id="billing_city" placeholder="" value="" />
                                @error('city')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
                            <p class="form-row form-row-wide address-field validate-validate-state" id="billing_state_field">
                                ...
                                <input  type="text" class="form-control w-100" value="" placeholder="" name="state" id="billing_state"  />
                                @error('state')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
                            <p class="form-row form-row-wide address-field validate-validate-postcode" id="billing_postcode_field">
                                ...
                                <input type="text" class="form-control w-100" name="postal_code" id="billing_postcode" placeholder="" value="" />
                                @error('postal_code')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
                            <p class="form-row form-row-first validate-validate-phone" id="billing_phone_field">
                                ...
                                <input type="tel" class="form-control w-100" name="phone" id="billing_phone" style="background:#121215;color:#787678;"  placeholder="" value="" />
                                @error('phone')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
                            <p class="form-row form-row-last validate-validate-email" id="billing_email_field" >
                                ...
                                <input type="email" class="form-control w-100" name="email" id="billing_email" placeholder="" value="" />
                                @error('email')
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                            </p>
        ...
        <div class="col-md-6 col-lg-6 col-sm-12 col-12">
            <table class="table rounded-3">
                ...
                <tr>
                    <td class="" colspan="2">Subscription Date</td>
                </tr>
                <tr><td>Date</td>
                    <td>  {{$date}}</td>
              </tr>
...
@endif
                ...
                <input type="hidden" value="{{$price_fix * $seat}}" name="sub_total">

                <div class="woocommerce-additional-fields__field-wrapper">
                    <p class="form-row notes" id="order_comments_field" data-priority="">

                        <div class="border py-3 px-2 bg-white rounded-3">
                            <img src="{{asset('assets/bankful.png')}}" class="w-25" alt="">
                            <div class="border py-3 my-2 px-3 rounded-3">
                                    ...
                                    <article class="card">
                                        ...
                                        <ul class="nav bg-light nav-pills rounded nav-fill mb-3" role="tablist">
                                            ...
                                            <li class="nav-item bg-secondary">
                                                ...
                                                <i class="fa fa-university"></i>  Sezzel</a></li>
                                        </ul>
                                        ...
                                        tempor incididunt ut labore et dolore magna aliqua. </p>
                                            ...
                                            <button class="btn btn-primary px-4 py-2 mt-4 float-end">Pay Now</button>
                                        </div> <!-- row.// -->
                                    </form>
