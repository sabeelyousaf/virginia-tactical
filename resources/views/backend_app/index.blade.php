        ...
        <div class="content-body">
            ...
            <section id="dashboard-ecommerce">
                ...
                <div class="row match-height">
                    ...
                    <!-- Revenue Report Card -->
                    <div class="col-lg-8 col-md-6 col-8 col-sm-12">
                        <div class="card">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge rounded-pill badge-light-primary me-1">Stripe</span></td>
                        ...
                        <div class="card card-transaction">
                            ...
                            <div class="card-body">
                                <div class="transaction-item">
                                    ...
                                    <div class="fw-bolder text-success">+{{$overallsum}}</div>
                                </div>
                                <div class="transaction-item">
                                    <div class="d-flex">
